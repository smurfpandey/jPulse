!function ( $ ) {
    ...
    jPulse.prototype.init = function ( options ) {
        if ( this.enabled ) {
            return;
        }
        ...
        return this.each(function () {
            if ( !$.data( this, "plugin_" + pluginName ) ) {
                ...
                if ( thisPlugin[ options ] ) {
                    return thisPlugin[options].apply( thisPlugin, Array.prototype.slice.call( arguments, 1 ) );
                } else if ( typeof options === "object" || !options ) {
                    return thisPlugin[ "init" ].call( thisPlugin, options );
                } else {
